...
(function () {
  ...
  var KK = {
    ...
    'rev.s4': '«Бэлла Жүргенов мектебіне 7-сыныпқа қабылданды» — оқушыларымыз Қазақстанның колледждері мен жоғары оқу орындарына түседі',
    'rev.s5': '13 жыл бұрын өзі келген — қазір балалары келеді: «Ұлым сіздердің арқаларыңызда мамандық таңдады»',
    'rev.s6': 'Аутизмі бар бала: «жайлы, кесте ыңғайлы, ең бастысы — шыдамдылық пен түсіністік»',
  ...
  var EN = {
    ...
    'rev.s4': '“Bella got into the Zhurgenov school, 7th grade” — our students go on to colleges and universities across Kazakhstan',
